...
const RightSideBar = ({ allOtherUsers }) => {
  return (
      ...
      <div className="flex-row items-center justify-between p-2 bg-gray-100 rounded-md ml-8 mt-4 w-full">
        ...
        {allOtherUsers?.map((user) => {
          return (
            <div
              key={user?._id}
              className="flex items-center rounded hover:bg-gray-200 transition-colors duration-300 ease-in-out "
            >
              <img
              ...
              <div>
                ...
                <p className=" mb-1 text-gray-500">@{user?.username}</p>
              </div>
              <img
